...
class BindReplaceAddressScreen extends BaseComponent {
    ...
    nextBtn() {
        this.props.navigation.navigate('BindReplaceAddressErc')
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(BindReplaceAddressScreen)
