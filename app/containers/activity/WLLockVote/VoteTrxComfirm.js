...
const InfoTextView = ({
  ...
  <View style={styles.leftInfoView}>
    ...
    <InfoContentView title={I18n.t('activity.nodeVote.id')} deatilContent={nodeNumber} />
    ...
    <InfoContentView title={I18n.t('activity.nodeVote.from')} deatilContent={fromAddress} />
    <InfoContentView
