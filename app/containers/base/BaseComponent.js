...
export default class BaseComponent extends PureComponent {
  ...
  _addEventListener() {
    ...
    this.pinIsShowHandler = DeviceEventEmitter.addListener(
      "pinIsShow",
      this._pinIsShowEmitter
    ); //监听pin是否显示
  ...
  _handleAppStateChange = nextAppState => {
    if (nextAppState != null && nextAppState === "active") {
      ...
      this.backgroundTimer =
        !Common.touchIDVertifing && nextAppState == "background"
          ? Date.now()
          : 0;
    ...
    return (
      ...
      >
        ...
        {this.state.isShowAlert == undefined ? null : (
          <MyAlert
            modalVisible={this.state.isShowAlert}
  ...
  _netRequestErr = err => {
    ...
    try {
      ...
      if (
        ...
        this.toast = showToast(
          I18n.t("toast.net_request_timeout"),
          Toast.positions.TOP + 10
        );
      } else if (
