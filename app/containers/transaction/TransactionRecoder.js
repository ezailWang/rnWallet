        ...
        <View style={{ flex: 1 }}>
          <View style={styles.tranContainer}>
            <View style={styles.addressContainer}>
              <Text
                style={{ fontSize: FontSize.TitleSize, color: Colors.fontBlackColor }}
                numberOfLines={1}
    ...
    if (this._isMounted) {
      ...
      if (isFirst) {
        ...
        if (lastTransaction) {
          ...
          //     const recoder = nowAllTransactions[index];
          //     if (lastTransaction.hash.toLowerCase() == recoder.hash.toLowerCase()) {
          //       didContainNewTransaction = true;
          //       break;
          //     }
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={[styles.bottomBtnView, bottomView, btnShadowStyle]}>
          ...
          >
            <Text style={{ color: Colors.fontBlueColor, textAlign: 'center', fontSize: 16 }}>
