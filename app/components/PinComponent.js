...
class PinPoint extends PureComponent{
    ...
    render(){
        ...
        return(
            <View style={[styles.pointView,this.props.pointStyle,this.props.isChecked ? styles.pointBoxChecked : styles.pointBoxUnchecked]}> 
            </View>
        )
    }
}
        ...
        return(
            <View style={[styles.circleContainer,this.props.circleStyle]}>
                <TouchableOpacity style={[styles.circleView]}
                    ...
                    <Text style={styles.circleText1}>{this.props.text1}</Text>
                    {this.props.isNeedLetter ? <Text style={styles.circleText2}>{this.props.text2}</Text> : null}
                </TouchableOpacity>
            </View>
